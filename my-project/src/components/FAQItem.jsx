...
const FaqAccordion = () => {
  ...
  const Faqs = [
    ...
    // {
    //   id: 5,
    //   question: "Can I use Banky for business purposes?",
    //   answer:
    //     "Yes, Banky offers businesses an easy and convenient way to collect payments from customers. We have a credit marketplace where business can list, monitor and approve credit products their customers apply for",
    // },
  ];
